...
- **Fixed about page hero image** — replaced incorrect London Bridge photo with Sheikh Zayed Grand Mosque; enforced minimum opacity floor of 15% on all section backgrounds (hero: 30% → 35%) across both homepage and about page
