...
- **Fixed about page hero image** — replaced incorrect London Bridge photo with Sheikh Zayed Grand Mosque; bumped all section background opacities slightly (hero: 30% → 35%, subtle backgrounds: 6–7% → 10–11%) to reduce excessive transparency on both the about and homepage
