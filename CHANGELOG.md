...
### Added
- **noon careers blog post** — added a new published blog article about using noon's careers site and hirebridge together for UAE job search; includes Alembic migration 0015 to seed the database row and a static fallback entry in `blog-content.ts`.
