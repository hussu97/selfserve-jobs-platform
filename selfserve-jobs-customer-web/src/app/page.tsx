        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {jobs.length > 0 ? (
            ...
            <div className="text-center py-16 rounded-2xl border border-border bg-surface">
              ...
              <p className="text-text-muted">No job listings yet.</p>
              <Link
                href="/jobs/new"
                className="mt-3 inline-block text-sm font-medium text-primary hover:opacity-70"
              >
                Post the first job →
              </Link>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {profiles.length > 0 ? (
            ...
            <div className="text-center py-16 rounded-2xl border border-border bg-bg">
              ...
              <p className="text-text-muted">No talent profiles yet.</p>
              <Link
                href="/profiles/new"
                className="mt-3 inline-block text-sm font-medium text-primary hover:opacity-70"
              >
